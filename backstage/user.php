        ...
        <main id="main" class="col-md-9">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php while ($item = mysqli_fetch_assoc($query)): ?>
                        <tr class="success">
                            ...
                            <td>
                                <?php echo $item['user_data'] ?>
                            </td>
                            <td>
                                <a class="btn btn-danger btn-sm" href="user_delete.php?id=<?php echo $item['id'] ?>">删除</a>
                            </td>
                        </tr>
                    <?php endwhile ?>
                    </tbody>
            ...
            <div >
                <ul class="pagination" style="float: right">
                    ...
                    echo "<li class=\"page-item\"><a class=\"page-link\" href='user.php?page=1'>".'&laquo;'."</a></li>"; //第一页
                    ...
                    echo "<li class=\"page-item\"><a class=\"page-link\" href = 'user.php?page=$total_pages'>".'&raquo;'."</a></li>"//最后一页
                    ?>
                </ul>
